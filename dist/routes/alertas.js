...
exports.criarAlertaComNotificacao = criarAlertaComNotificacao;
...
async function criarAlertaComNotificacao(fazendaId, tipo, titulo, descricao) {
    ...
    // Push notification
    await (0, notificacoes_1.sendPushToUser)(fazenda.userId, titulo, descricao, '/app/alertas');
